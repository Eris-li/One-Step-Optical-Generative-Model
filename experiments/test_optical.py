...
Usage:
    Training (with DDPM distillation):  python experiments/test_optical.py --mode train --num_epochs 10
    Generate: python experiments/test_optical.py --mode generate --checkpoint <path>
    Compare:  python experiments/test_optical.py --mode compare --ddpm_checkpoint <path>
"""
import os
import sys
import torch
...
OGM_CORE_DIR = os.path.join(PROJECT_ROOT, "third_party", "ogm")
EXPERIMENTS_DIR = os.path.join(PROJECT_ROOT, "experiments")
sys.path.insert(0, OGM_CORE_DIR)
sys.path.insert(0, EXPERIMENTS_DIR)

from test_example_mnist import Generator_ClsEmd_light, D2nnModel
...
class OpticalGenerativeModel:
    ...
    def __init__(self, output_dir="./outputs/optical"):
...
def main():
    ...
    parser.add_argument("--output_dir", type=str, default="./outputs/optical")
    parser.add_argument("--checkpoint", type=str, default=None)
    parser.add_argument("--ddpm_checkpoint", type=str, default="./outputs/ddpm/ddpm_final.pth")
    ...
    if args.mode == "train":
        ...
        if not os.path.exists(checkpoint_path):
            ...
            print("Please train first: python experiments/test_optical.py --mode train")
            return
        ...
        from test_ddpm import DDPMGenerator
