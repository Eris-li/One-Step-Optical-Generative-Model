...
REFRACTIVEINDEX_DIR = os.path.join(MODULE_DIR, "refractiveindex")
...
def extract_material_parameter(frequency, mask_amp_modulation):
    measurement_path = os.path.join(REFRACTIVEINDEX_DIR, "RefIndexMeasurements_1.mat")
    measurement_file = scio.loadmat(measurement_path)
