...
Usage:
    Training:  python experiments/test_ddpm.py --mode train --num_epochs 10
    Generate: python experiments/test_ddpm.py --mode generate --checkpoint <path> --specific_digit 7
"""
import os
import sys
import torch
...
class DDPMGenerator:
    ...
    def __init__(self, output_dir="./outputs/ddpm"):
