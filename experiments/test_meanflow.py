...
Usage:
    Training:  python experiments/test_meanflow.py --mode train --num_epochs 10
    Generate:  python experiments/test_meanflow.py --mode generate --checkpoint <path> --specific_digit 7
"""
import os
import sys
...
THIRD_PARTY_MEANFLOW_DIR = os.path.join(PROJECT_ROOT, "third_party", "meanflow")
sys.path.insert(0, THIRD_PARTY_MEANFLOW_DIR)
...
class MeanFlowGenerator:
    def __init__(self, output_dir="./outputs/meanflow"):
...
def main():
    ...
    if args.mode == "train":
        ...
        if not os.path.exists(checkpoint_path):
            ...
            print("Please train first: python experiments/test_meanflow.py --mode train")
            return
